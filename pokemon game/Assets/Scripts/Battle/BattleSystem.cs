...
public class BattleSystem : MonoBehaviour
{
    ...
    IEnumerator RunAfterTurn(BattleUnit sourceUnit)
    {
        ...
        // hurting the pokemon after the turn
    ...
    {
        while (pokemon.StatusChages.Count > 0)
        {
            var message = pokemon.StatusChages.Dequeue();
            ...
            while (playerUnit.Pokemon.CheckForLevelUp())
            {
                ...
                if (newMove != null)
                {
                    ...
                    else
                    {
                        ...
                        yield return dialogBox.TypeDialog($"But it cannot learn more then {PokemonBase.MaxNumOfMoves} moves");
    ...
    public void HandleUpdate()
    {
        ...
        else if (state == BattleState.MoveToForget)
        {
            Action<int> onMoveSelected = (moveIndex) =>
            {
                ...
                {
                    // forget the move and learn new one
